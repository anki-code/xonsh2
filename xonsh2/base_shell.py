...
from xonsh2.prompt.base import multiline_prompt, PromptFormatter
from xonsh2.events import events
from xonsh2.shell import transform_command
from xonsh2.lazyimps import pygments, pyghooks
from xonsh2.ansi_colors import ansi_partial_color_format
...
class BaseShell(object):
    ...
    def styler(self):
        if self._styler is DefaultNotGiven:
            if HAS_PYGMENTS:
                from xonsh2.pyghooks import XonshStyle
