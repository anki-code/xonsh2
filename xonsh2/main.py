...
@lazyobject
def parser():
    p = argparse.ArgumentParser(description="xonsh2", add_help=False)
    p.add_argument(
        "-h",
        "--help",
        dest="help",
    ...
    p.add_argument(
        "--no-rc",
        help="Do not load the .xonshrc_2 files.",
        dest="norc",
        action="store_true",
        default=False,
    )
