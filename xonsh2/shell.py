...
class Shell(object):
    ...
    def __init__(self, execer, ctx=None, shell_type=None, **kwargs):
        ...
        if shell_type == "none":
            from xonsh2.base_shell import BaseShell as shell_class
        elif shell_type == "prompt_toolkit":
            from xonsh2.ptk_shell.shell import PromptToolkitShell as shell_class
        elif shell_type == "readline":
            from xonsh2.readline_shell import ReadlineShell as shell_class
        elif shell_type == "jupyter":
            from xonsh2.jupyter_shell import JupyterShell as shell_class
        elif shell_type == "dumb":
            from xonsh2.dumb_shell import DumbShell as shell_class
        else:
