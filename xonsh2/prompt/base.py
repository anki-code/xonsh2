...
from xonsh2.prompt.cwd import (
    _collapsed_pwd,
    _replace_home_cwd,
    _dynamically_collapsed_pwd,
)
from xonsh2.prompt.job import _current_job
from xonsh2.prompt.env import env_name, vte_new_tab_cwd
from xonsh2.prompt.vc import current_branch, branch_color, branch_bg_color
from xonsh2.prompt.gitstatus import gitstatus_prompt
from xonsh2.prompt.times import _localtime
